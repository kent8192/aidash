...
- Tasks 2–8 remain open. Scoped tasks support local admission and local child delegation with intersected authority. Scoped remote delegation and legacy admission remain closed. Finer resource-level grants, the remaining mesh paths and the dashboard still require implementation; none of the six expanded requirements is complete end to end.
