...
- [ ] Introduce hashed, revocable subject credentials and persisted resource ownership. Keep the operator credential explicitly limited to administrative bootstrap/recovery.
...
- Tasks 2–8 remain open. The policy service does not yet protect the existing mesh data paths, and none of the six expanded requirements is complete end to end.
