...
| FR-AGENT-001 | Automatic agent generation        | [Policy, provisioning, inherited authority, limits, lifecycle and bilingual dashboard](generation.md) implemented; approved compaction and full acceptance pending     | Missing-agent task completion; retry/restart deduplication, limits and denied approval                                                               |
