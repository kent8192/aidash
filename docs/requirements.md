...
| FR-AUTH-001  | Complex RBAC / ABAC               | Policy service, workspace APIs, tenant catalog and local worker enforcement implemented; finer resource scopes, remote paths and UI pending | Policy/API/PostgreSQL tests, two-tenant isolation, live revocation, local effects and child authority; all-path authorization remains to be verified |
