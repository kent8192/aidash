...
| FR-AGENT-001 | Automatic agent generation        | [Policy, provisioning, inherited authority, limits and lifecycle backend](generation.md) implemented; bilingual UI, approved compaction and full acceptance pending    | Missing-agent task completion; retry/restart deduplication, limits and denied approval                                                               |
